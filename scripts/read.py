# Jim's python 2 code; needs tidying
# - relies on pyfits, which has some py2 dependencies that need resolving (could implement with astropy instead)
# - all this does is read in images from csv (?) and output a fits file for CASA to work with
#
